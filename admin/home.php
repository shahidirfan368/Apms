...
<body class="hold-transition skin-red sidebar-mini" style="background-color: rgb(255,99,71)";>
<div class="wrapper"  style="background-color: gray";>
  ...
  <div class="content-wrapper hold-transition skin-red sidebar-mini" style="background-color: rgb(255,99,71)" >
    <!-- Content Header (Page header) -->
    <section class="content-header" style="background-color: rgb(255,99,71)";>
      <h1>
        Dashboard
      </h1>
      <ol class="breadcrumb" >
    ...
    <!-- Main content -->
    <section class="content"style="background-color: rgb(255,99,71)">
      <?php
      ...
      <div class="row" style="background-color: rgb(255,99,71) ";>
