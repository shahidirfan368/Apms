...
error:function (){}
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                  <h1>      <div class="page-title"style="background-color:rgba(255,99 ,71);">Add Employee</div></h1>
                    </div>
...
<label for="empcode">Employee Code(Must be unique)</label><br>
<br>
...
<select  name="gender" autocomplete="off"><br>
<br>
